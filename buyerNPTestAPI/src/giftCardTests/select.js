...
module.exports = async function select({ context, message } = {}, logs = [],constants ={}) {
    ...
    try {
        // const constants = { action: "select", version: "2.0.0" };
        ...
        console.log(err);
        testSuite.addTest(new Mocha.Test("select payload could not be verified due to some payload missing or internal error", function () {
