...
module.exports = function contextTests(context, action, testSuite, version) {
    ...
    contextTestSuite.addTest(new Mocha.Test("should verify the content of 'context.domain', should be equal to 'ONDC:NTS10'", function () {
        expect(context.domain).to.be.a("string").and.to.be.equal("ONDC:NTS10");
    }));
    ...
    contextTestSuite.addTest(new Mocha.Test("should verify the transaction_id of the payload (OPTIONAL)", function () {
