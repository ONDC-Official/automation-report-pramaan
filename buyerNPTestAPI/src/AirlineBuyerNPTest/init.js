...
module.exports = async function init({ context, message } = {}, category, settlementAmount, logs = [], constants = {}) {
    try {
        ...
        messageTestSuite.addTest(new Mocha.Test("Verify the presence of 'message.order.item' which is an array", function () {
