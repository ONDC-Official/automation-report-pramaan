...
//  * @param {Object} constants - An Object containing constant fields like state, etc
//  * @returns {Mocha.Suite}  Generated test suite.
//  */
// function generateTests(message, schema, suiteName = "", constants = {}) {
...
//                 suite.addTest(
//                     new Mocha.Test(
//                         `'[id: ${property?.id}_minLength] ${fullPath}' should have minLength ${property.minLength}`,
//                         function () {
...
//                 suite.addTest(
//                     new Mocha.Test(
//                         `'[id: ${property?.id}_enum] ${fullPath}' should be one of [${property.enum.join(", ")}]`,
//                         function () {
...
//                 suite.addTest(
//                     new Mocha.Test(
//                         `'[id: ${property?.id}_${property.const}] ${fullPath}' should equal '${constants[property.const]}'`,
//                         function () {
...
//                 suite.addTest(
//                     new Mocha.Test(
//                         `'[id: ${property?.id}_pattern] ${fullPath}' should match pattern ${property.pattern}`,
//                         function () {
...
//                 suite.addTest(
//                     new Mocha.Test(
//                         `'[id: ${property?.id}__notPattern] ${fullPath}' should not match pattern ${property.not.pattern}`,
//                         function () {
