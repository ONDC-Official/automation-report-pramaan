...
function confirmMessageTests({ context, message } = {}, constants = {}, testCaseId) {
    try {
...
module.exports = async function confirm({ context, message } = {}, testCaseId, logs = [], constants = {}) {
    try {
        const testSuite = new Mocha.Suite("confirm request verification");
        
        testSuite.addSuite(contextTests(context, constants, logs));
        testSuite.addSuite(confirmMessageTests({ context, message }, constants, testCaseId));
