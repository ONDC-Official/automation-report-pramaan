    ...
    try {
        ...
        if (message?.order?.fulfillments && message?.order?.fulfillments.length > 0) {
            message.order.fulfillments.forEach((fulfillment, fulfillmentIndex) => {
                ...
                if (flowId === "INVESTMENT_1" || flowId === "INVESTMENT_2" || flowId === "INVESTMENT_3" || flowId === "INVESTMENT_4" || flowId === "INVESTMENT_11" || flowId === "INVESTMENT_15" || flowId === "INVESTMENT_13" || flowId === "INVESTMENT_16" || flowId === "INVESTMENT_14") {
                    messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.fulfillments[${fulfillmentIndex}].id' should be one of valid ENUMS`, function () {
                ...
                if (flowId === "INVESTMENT_7A" || flowId === "INVESTMENT_7B" || flowId === "INVESTMENT_7C" || flowId === "INVESTMENT_7D") {
                    messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.fulfillments[${fulfillmentIndex}].id' should be equal to valid ENUM`, function () {
                ...
                if (fulfillment?.customer?.person?.creds) {
                    if (flowId === "INVESTMENT_1" || flowId === "INVESTMENT_2" || flowId === "INVESTMENT_3" || flowId === "INVESTMENT_11" || flowId === "INVESTMENT_12" || flowId === "INVESTMENT_13" || flowId === "INVESTMENT_14" || flowId === "INVESTMENT_15" || flowId === "INVESTMENT_16" || flowId === "INVESTMENT_5" || flowId === "INVESTMENT_6" || flowId === "INVESTMENT_7A" || flowId === "INVESTMENT_7D" || flowId === "INVESTMENT_7C" || flowId === "INVESTMENT_7B" || flowId === "INVESTMENT_20") {
                ...
                if (["INVESTMENT_3", "INVESTMENT_5", "INVESTMENT_9", "INVESTMENT_7", "INVESTMENT_11", "INVESTMENT_13", "INVESTMENT_14", "INVESTMENT_15", "INVESTMENT_16", "INVESTMENT_12"].includes(flowId)) {
                    messageTestSuite.addTest(new Mocha.Test(
                        ...
                        function () {
                            ...
                            const hasFolio = creds.some(c => c?.type === "FOLIO" && typeof c.id === "string" && c.id.trim() !== "");
                ...
                fulfillment?.agent?.organization?.creds.forEach((cred, credIndex) => {
                    ...
                    if (flowId === "INVESTMENT_7A" || flowId === "INVESTMENT_7B" || flowId === "INVESTMENT_7C" || flowId === "INVESTMENT_7D") {
                        ...
                        if (fulfillment?.tags && fulfillment.tags.length > 0) {
                            ...
                            const payoutTag = fulfillment?.tags?.find(tag => tag?.descriptor?.code === "PAYOUT_BANK_ACCOUNT");
                            ...
                            if (payoutTag) {
                                const identifierItem = payoutTag.list.find(item => item?.descriptor?.code === "IDENTIFIER");
                                ...
                                messageTestSuite.addTest(new Mocha.Test(
                                    ...
                                    function () {
                                        ...
                                        expect(identifierItem).to.have.property("value").that.is.a("string").and.is.not.empty;
                                    }
                                ));
                            }
                        }
        ...
        if (
            ...
            messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.xinput.form' should have a property named 'id' which is a string`, function () {
            ...
            messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.xinput.form_response' should have a property named 'submission_id' which is a string`, function () {
            ...
            if (message?.order?.payments && message?.order?.payments.length > 0) {
                message.order.payments.forEach((payment, paymentIndex) => {
                    ...
                    if (payment.hasOwnProperty("id")) {
                        messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.payments[${paymentIndex}].id' should be a string (OPTIONAL)`, function () {
                    ...
                    if (flowId === "INVESTMENT_1" || flowId === "INVESTMENT_2" || flowId === "INVESTMENT_3" || flowId === "INVESTMENT_11" || flowId === "INVESTMENT_15" || flowId === "INVESTMENT_13" || flowId === "INVESTMENT_12" || flowId === "INVESTMENT_16" || flowId === "INVESTMENT_14" || flowId === "INVESTMENT_5" || flowId === "INVESTMENT_9" || flowId === "INVESTMENT_6" || flowId === "INVESTMENT_20") {
        ...
        // Explicit validation for BAP_TERMS tag
        if (message?.order?.tags && message?.order?.tags.length > 0) {
            const bapTermsTag = message.order.tags.find(tag => tag?.descriptor?.code === "BAP_TERMS");

            messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'message.order.tags' should contain a tag with descriptor.code = 'BAP_TERMS'`, function () {
                expect(bapTermsTag).to.exist.and.to.be.an("object");
            }));

            if (bapTermsTag) {
                messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] 'BAP_TERMS' tag should contain 'list' array`, function () {
                    expect(bapTermsTag).to.have.property("list").that.is.an("array");
                }));

                const staticTerms = bapTermsTag?.list.find(item => item?.descriptor?.code === "STATIC_TERMS");
                const offlineContract = bapTermsTag?.list.find(item => item?.descriptor?.code === "OFFLINE_CONTRACT");

                messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] BAP_TERMS.list should contain item with descriptor.code = 'STATIC_TERMS'`, function () {
                    expect(staticTerms).to.exist.and.to.be.an("object");
                }));

                messageTestSuite.addTest(new Mocha.Test(`[${testCaseId}${getNextTestcaseId()}] BAP_TERMS.list should contain item with descriptor.code = 'OFFLINE_CONTRACT'`, function () {
                    expect(offlineContract).to.exist.and.to.be.an("object");
                }));
            }
        }
