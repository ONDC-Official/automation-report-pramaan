...
function onSelectMessageTests({ context, message }, constants,testCaseId,) {
    try {
        
        // generating the tests using recursive methods
        const messageTestSuite = generateTests({ context, message }, onSelectSchema, "Verification of Message", constants, testCaseId);
...
module.exports = async function on_select({ context, message } = {}  ,testCaseId,logs = [],constants = {}) {
    try {
        ...
        testSuite.addSuite(onSelectMessageTests({ context, message }, constants,testCaseId));
