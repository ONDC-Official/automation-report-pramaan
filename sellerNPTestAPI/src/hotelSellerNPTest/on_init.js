...
function onInitMessageTests({ context, message }, testCaseId,) {
    try {
...
module.exports = async function on_init({ context, message } = {},  flowId = "", testCaseId,logs = [],constants = {}) {
    ...
    try {
        ...
        testSuite.addSuite(onInitMessageTests({ context, message }, testCaseId));
