...
module.exports = {
  ...
  "properties": {
    "order": {
      ...
      "properties": {
        "offers": {
          "id": "retail_bpp_message_offers_on_update",
          "type": "array",
          "optional": true,
          "minItems": 1,
          "element": {
            "id": "retail_bpp_message_offers_element_on_update",
            "type": "object",
            "properties": {
              "id": {
                "id": "retail_bpp_message_offers_id_on_update",
                "type": "string",
                "minLength": 1
              }
            }
        ...
        "payments": {
          ...
          "minItems": 1,
          "element": {
            "id": "retail_bpp_on_cancel_message_payment_element",
            "type": "object",
            "properties": {
              // "uri": {
              //   "type": "string",
