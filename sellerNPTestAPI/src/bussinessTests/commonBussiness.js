 ...
 * @param {*} message 
 */
function contextBussinessTests(contextTestSuite, context, logs) {
    try {
        ...
        if (index !== 0) {
            ...
            contextTestSuite.addTest(new Mocha.Test(`'context.bap_uri' should be same as send in the first call`, function () {
        ...
        if (context?.action !== "search") {
            ...
            contextTestSuite.addTest(new Mocha.Test(`'context.bpp_uri' should be same as received in the first call`, function () {
