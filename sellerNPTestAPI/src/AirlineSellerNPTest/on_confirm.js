...
async function on_confirm({ context, message } = {}, settlementAmount, logs = [], constants = {}) {
        ...
        if (message?.order?.fulfillments && message?.order?.fulfillments.length > 0) {
            message.order.fulfillments.forEach((fulfillment, fulfillmentIndex) => {
                ...
                if (fulfillment?.customer) {
                    ...
                    messageTestSuite.addTest(new Mocha.Test(`verify that 'message.order.fulfillment[${fulfillmentIndex}].customer.contact.email' should be a string`, function () {
                ...
                if (fulfillment?.type === "TRIP") {
                    messageTestSuite.addTest(new Mocha.Test(`Verify the presence of 'message.order.fulfillments[${fulfillmentIndex}].tags' which is an array (OPTIONAL)`, function () {
