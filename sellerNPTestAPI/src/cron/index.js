...
class CronJobScheduler {
    ...
    // Method to schedule the cron job at 3:25 PM IST
    scheduleJob() {
        if (this.task) {
        ...
        const cronExpression = `25 15 * * *`; // Runs at 3:25 PM AM IST
        ...
        console.log("Cron job scheduled to run at 3:25 PM AM IST");
    }
