...
function onUpdateMessageTests({ context, message }, logs = []) {
    try {
        ...
        messageTestSuite.addTest(new Mocha.Test("Verify the presence of 'message.order.updated_at' which is a string and is greater than that of in 'update'", function () {
