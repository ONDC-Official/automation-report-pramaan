module.exports = {
    ...
    "search": {
        "properties": {
            "domain": {
                "id": "retail_bpp_context_01", "type": "string", "minLength": 1, "enum": ["ONDC:RET12", "ONDC:RET11", "ONDC:RET10", "ONDC:RET18", "ONDC:RET14", "ONDC:RETINVL"]
            },
    ...
    "others": {
        "properties": {
            "domain": {
                "id": "retail_bpp_context_12", "type": "string", "minLength": 1, "enum": ["ONDC:RET12", "ONDC:RET11", "ONDC:RET10", "ONDC:RET18", "ONDC:RET14", "ONDC:RETINVL"]
            },
