            ...
            message.order.fulfillments.forEach((fulfillment, fulfillmentIndex) => {
                ...
                if (fulfillment?.stops && fulfillment?.stops.length > 0) {
                    fulfillment.stops.forEach((stopItem, stopIndex) => {
                        ...
                        messageTestSuite.addTest(new Mocha.Test(`Verify the presence of 'message.order.fulfillments[${fulfillmentIndex}].stops[${stopIndex}].instructions (OPTIONAL)' which is an object`, function () {
