...
async function on_select({ context, message } = {}, step, flowId, logs = [], constants = {}) {
    try {
        ...
        if (flowId !== "INVESTMENT_7A" && flowId !== "INVESTMENT_7B" && flowId !== "INVESTMENT_7C" && flowId !== "INVESTMENT_7D") {
            ...
            if ((flowId === "INVESTMENT_6" && step === "I") || (flowId === "INVESTMENT_3") || (flowId === "INVESTMENT_13") || (flowId === "INVESTMENT_5") || (flowId === "INVESTMENT_12") || (flowId === "INVESTMENT_9") || (flowId === "INVESTMENT_20" && step !== "IV") || (flowId === "INVESTMENT_1" && step !== "IV") || (flowId === "INVESTMENT_2" && step === "I")) {
