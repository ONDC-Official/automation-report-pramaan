...
async function on_init({ context, message } = {},  flowId,logs = [],constants = {}) {
    try {
        let action = "on_init";
        ...
        if (flowId !== "INVESTMENT_3" && flowId !== "INVESTMENT_1" && flowId !== "INVESTMENT_2" && flowId !== "INVESTMENT_5" && flowId !== "INVESTMENT_7" && flowId !== "INVESTMENT_6" && flowId !== "INVESTMENT_20" && flowId !== "INVESTMENT_9") {
