...
async function on_status({ context, message } = {}, logs = [], flowId) {
    try {
        ...
        if (flowId !== "INVESTMENT_3" && flowId !== "INVESTMENT_6" && flowId !== "INVESTMENT_7" && flowId !== "INVESTMENT_20" && flowId !== "INVESTMENT_9") {
