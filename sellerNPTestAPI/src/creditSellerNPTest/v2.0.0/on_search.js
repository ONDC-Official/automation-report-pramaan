    ...
    try { 
        ...
        if (message?.catalog?.providers && message?.catalog?.providers.length > 0) {
            message?.catalog?.providers.forEach((provider, index) => {
                ...
                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].descriptor' should be exist and should be an object`, function () {
                    expect(provider.descriptor).to.exist.and.to.be.an("object");
                }));

                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].descriptor' should have a property 'name'`, function () {
                    expect(provider.descriptor.name).to.exist.and.to.be.a("string");
                }));

                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].descriptor' should have a property 'short_desc' (OPTIONAL)`, function () {
                    expect(provider.descriptor.short_desc).to.exist.and.to.be.a("string");
                }));

                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].descriptor' should have a property 'long_desc' (OPTIONAL)`, function () {
                    expect(provider.descriptor.long_desc).to.exist.and.to.be.a("string");
                }));

                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].descriptor' should have a property 'images' that is an array`, function () {
                ...
                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].categories' should exists and should be an array that is not empty`, function () {
                ...
                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items' should exist and should be an array that is not empty`, function () {
                    ...
                    provider?.items.forEach((item, i) => {
                        ...
                        if (item?.tags && item?.tags.length > 0) {
                            item?.tags.forEach((tag, j) => {
                                ...
                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].tags[${j}].descriptor' should have properties 'code' and 'name' which should be a string`, function () {
                                    expect(tag.descriptor.code).to.exist.and.to.be.a("string");
                                    expect(tag.descriptor.name).to.exist.and.to.be.a("string");
                                }));

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].tags[${j}].descriptor.code' should be equal to 'GENERAL_INFO'`, function () {
                                    expect(tag.descriptor.code).to.equal("GENERAL_INFO");
                                }));

                                /* messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].tags[${j}].descriptor.name' should be equal to 'General Information'`, function () {
                                    expect(tag.descriptor.name).to.equal("General Information");
                                })); */

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].tags[${j}].display' should be boolean`, function () {
                                    expect(tag.display).to.be.a('boolean');
                                }));

                                if (tag?.list && tag?.list.length > 0) {
                                    tag?.list.forEach((listItem, k) => {
                                        messageTestSuite.addTest(new Mocha.Test(`should validate the contents of 'message.catalog.providers[${index}].items[${i}].tags[${j}].list[${k}]' (${listItem.descriptor.code})`, function () {
                                        ...
                                        messageTestSuite.addTest(new Mocha.Test(`should validate the contents of 'message.catalog.providers[${index}].items[${i}].tags[${j}].list[${k}].descriptor' (${listItem.descriptor.code})`, function () {
                                            ...
                                            expect(listItem.descriptor.name, `'message.catalog.providers[${index}].items[${i}].tags[${j}].list[${k}].descriptor.name' should exist and be a string`).to.exist.and.to.be.a("string");
                                            expect(listItem.descriptor.short_desc, `'message.catalog.providers[${index}].items[${i}].tags[${j}].list[${k}].descriptor.short_desc' should exist and be a string`).to.exist.and.to.be.a("string");
                                        }));

                                        messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].tags[${j}].list[${k}].descriptor.code' should be in snakecase and capitalize (${listItem.descriptor.code})`, function () {
                                            expect(listItem.descriptor.code).to.match(codePattern);
                                        }));

                                        messageTestSuite.addTest(new Mocha.Test(`'message.order.items[${i}].tags[${j}].list[${k}].descriptor.name' should be a string (${listItem.descriptor.code})`, function () {
                                            expect(listItem.descriptor.name).to.be.a("string");
                                        }));

                                        messageTestSuite.addTest(new Mocha.Test(`'message.order.items[${i}].tags[${j}].list[${k}].value' should be a string (${listItem.descriptor.code})`, function () {
                                ...
                                if (action === "onsearch") {
                                    ...
                                    messageTestSuite.addTest(new Mocha.Test(`should validate the contents of 'message.catalog.providers[${index}].items[${i}].xinput.head'`, function () {
                                    ...
                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.descriptor.name' should be 'Customer Information'`, function () {
                                        expect(item.xinput.head.descriptor.name).to.be.a("string").and.to.equal("Customer Information");
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`should validate the contents of 'message.catalog.providers[${index}].items[${i}].xinput.index'`, function () {
                                    ...
                                    messageTestSuite.addTest(new Mocha.Test(`should validate the contents of 'message.catalog.providers[${index}].items[${i}].xinput.head.index.min'(OPTIONAL)`, function () {
                                        expect(item.xinput.head.index.min).to.exist.and.to.be.a("number");
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.index.min' should be equal to '0'`, function () {
                                        expect(item.xinput.head.index.min).to.equal(0);
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.index.cur' should be equal to '0'`, function () {
                                        expect(item.xinput.head.index.cur).to.equal(0);
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.index.max' should be equal to '0'`, function () {
                                        expect(item.xinput.head.index.max).to.equal(0);
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.headings' must have length '1'`, function () {
                                    ...
                                    if (item?.xinput?.head?.headings && item?.xinput?.head?.headings.length > 0) {
                                        item?.xinput?.head?.headings.forEach((heading, l) => {
                                            messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.head.headings[${l}]' should be equal to 'Personal Information'`, function () {
                                    ...
                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.form.resubmit should be a boolean`, function () {
                                        expect(item.xinput.form.resubmit).to.be.a("boolean");
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.form.multiple_sumbissions should be a boolean`, function () {
                                        expect(item.xinput.form.multiple_sumbissions).to.be.a("boolean");
                                    }));

                                    messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].items[${i}].xinput.required' should be a boolean`, function () {
                    ...
                    provider?.payments.forEach((payment, index) => {
                        ...
                        if (payment?.tags && payment?.tags.length > 0) {
                            ...
                            arr.forEach((ele, i) => {
                                ...
                                messageTestSuite.addTest(new Mocha.Test(`'message.order.payments[${index}].tags[${eleIndex}].display' to be 'false'`, function () {
                                    expect(tag.display).to.equal(false);
                                }));
                ...
                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags' should exist and should be an array that is not empty`, function () {
                    expect(provider.tags).to.exist.and.to.be.an("array").that.is.not.empty;
                }));

                if (provider?.tags && provider?.tags.length > 0) {
                    provider?.tags.forEach((tag, i) => {
                        messageTestSuite.addTest(new Mocha.Test(`should verify the contents of 'message.catalog.providers[${index}].tags[${i}]'`, function () {
                            expect(tag).to.have.property('descriptor').that.is.an('object');
                            expect(tag).to.have.property('list').that.is.an('array').not.empty;
                        }));

                        messageTestSuite.addTest(new Mocha.Test(`should verify the contents of 'message.catalog.providers[${index}].tags[${i}].descriptor' should have properties 'code' and 'name'`, function () {
                        ...
                        messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].descriptor.code' should be one of 'LSP_INFO' or 'CONTACT_INFO'`, function () {
                            expect(tag.descriptor.code).to.be.a("string").and.oneOf(["CONTACT_INFO", "LSP_INFO"]);
                        }));

                        messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].descriptor.name' should be one of 'Lsp Info' or 'Contact Info'`, function () {
                            expect(tag.descriptor.name).to.be.a("string").and.oneOf(["Contact Info", "Lsp Info"]);
                        }));

                        if (tag?.list && tag?.list.length > 0) {
                            tag?.list.forEach((listItem, j) => {
                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].list[${j}]' (${listItem.descriptor.code}) should have 'descriptor' and 'value' properties`, function () {
                                    expect(listItem).to.have.property('descriptor').that.is.an('object');
                                    expect(listItem).to.have.property('value');
                                }));

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].list[${j}].descriptor' (${listItem.descriptor.code}) should have properties 'code' 'name'`, function () {
                                    expect(listItem.descriptor).to.include.all.keys("code", "name");
                                    expect(listItem.descriptor.code).to.exist;
                                    expect(listItem.descriptor.name).to.exist;
                                }));

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].list[${j}].descriptor.code' (${listItem.descriptor.code}) should be a string and should be in snakecase and capitalize`, function () {
                                    expect(listItem.descriptor.code).to.be.a("string").and.to.match(codePattern);
                                }));

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].list[${j}].descriptor.name' (${listItem.descriptor.code}) should be a string`, function () {
                                    expect(listItem.descriptor.name).to.be.a("string");
                                }));

                                messageTestSuite.addTest(new Mocha.Test(`'message.catalog.providers[${index}].tags[${i}].list[${j}].value' (${listItem.descriptor.code}) should have expected expected data type`, function () {
        ...
        messageTestSuite.addTest(new Mocha.Test("on_search message could not be verified due to some property missing in payload or some internal error", function() {
